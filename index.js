...
async function connectToWA() {
  try {
    console.log("[ ♻ ] Connecting nova to WhatsApp ⏳️...")
    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*ᴄᴏɴɢʀᴀᴛꜱ, ɴᴏᴠᴀ ɪꜱ ᴄᴏɴɴᴇᴄᴛᴇᴅ, ʀᴇᴀᴅʏ ᴛᴏ ʀᴏᴄᴋ ✨* 
...
> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚉𝚎𝚍 space`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/xv34mh.jpeg` }, caption: up })
...
if (senderNumber.includes("212684255286") && !isReact) {
